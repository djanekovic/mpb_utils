...
koji će biti primjenjiv za sve dijagrame. TE komponenta uvijek će biti prikazana
plavom bojom, a TM crvenom. Frekvencijski raspori će uvijek biti prikazivani kao
plavi odnosno crveni pravokutnici. Os x označavat će iznos valnog vektora
$\mathbf{\beta}$, a y, frekvenciju izraženu kao ${\omega a/ 2 \pi c}$.
...
\begin{figure}[h]
	...
	\caption{Disperzijski dijagram za kvadratnu rešetku.}
...
\begin{figure}[h]
	...
	\caption{Disperzijski dijagram za trokutastu rešetku.}
