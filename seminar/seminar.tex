...
\centering
    ...
    označenom
    Weigner-Seintzovom ćelijom]{\includegraphics[width=0.45\linewidth]
...
\section{Kvadratna rešetka dielektričnih stupića} \label{sec:triangle}
...
\begin{figure}[ht]
\centering
    \subfloat[Heksagonalna rešetka u realnom prostoru s ucrtanim baznim vektorima i označenom
    Weigner-Seintzovom ćelijom]{\includegraphics[width=0.45\linewidth]
    {./images/pdf/triangular_lattice.pdf}}%
    \qquad
    \subfloat[Heksagonalna rešetka u inverznom prostoru s označenom Brillouinovom i prvom
    Brillouinovom zonom.]{\includegraphics[width=0.45\linewidth]
...
\begin{figure}[ht]
	...
	mod iako preklapanje ne postoji.}
	\label{fig:triangular_band_diagram}
\end{figure}

\FloatBarrier

\section {Heksagonalna rešetka za fotonički zabranjeni pojas}
...
\centering
	...
	Polumjer stupića u ovoj rešetci iznosi ${0.45 \, a}$]
	{\includegraphics[width=0.45\linewidth]
...
Iz primjera do sad može se zaključiti da će više simetrična rešetka poput
heksagonalne pokazati veći zabranjeni pojas. Također, intuitivno bi se dalo
...
11, plavo će biti označen TM, crveno TE mod, a žuto potpuni zabranjeni pojas,
odnosno mjesto gdje se pojas za TE i za TM mod preklapaju.

Budući da su on najveće važnosti baš fotonički zabranjeni pojas, optimizacija
će ići na njihovu ruku.

\section{Heksagonalna rešetka s cilindičnim stupićima}\label{section:cyl}
...
\centering
    ...
    \qquad
    \subfloat[Graf ovisnosti veličine fotoničkog zabranjenog pojasa i polumjera
    stupića. Maksimum se poprima za polumjer $0.478547 \, a$ i iznosi $17.05456$]
...
\section{Heksagonalna rešetka s kvadratnim stupićima}
...
\centering
    ...
    kvadrata. Maksimum se poprima za vrijednost stranice kvadrata $0.689655 \, a$
    i iznosi $0.453280$.]
...
zamjetan zabranjeni pojas za TE mod. Optimalna konfiguracija prikazana 
