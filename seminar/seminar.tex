...
dielektričnim tenzorom $\varepsilon_0 \varepsilon_{ij}$
\cite{time-harmonic_maxwell}. Frekvencijska ovisnost dielektrične permeabilnosti
bit će zanemarena. Konačno, nakon svih pretpostavki jednadžbe \ref{eq:maxwell1}
